    ...
    if(isset($_FILES['image'])){
        ...
        if ( $nom != "" && $prenom !="" && $phone !="" && $mail !=""){
            ...
            try{
                ...
                $requete = "INSERT INTO `contact` (`id`, `nom`, `prenom`, `numTel`, `email`, `photo`, `photo_type`) VALUES (NULL , '$nom', '$prenom', '$phone', '$mail','$img_final' ,'$img_type')";

                $idcom_aj->query($requete);
                $idcom_aj = NULL;

                echo "<script>setTimeout(function(){".
                    "document.location = 'index.php' ;} , 3000); ".
                "alert('Ajout OK'); </script>";
            }
            catch(PDOException $except){
            ...
            echo "<script>setTimeout(function(){" .
                "document.location = 'index.php' ;} , 3000); " .
                "alert('Probleme Lors de L'Ajout); </script>";
        }
    }
    else
