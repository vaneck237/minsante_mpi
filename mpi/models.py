...
class Patient(models.Model):
    ...
    num_passeport = models.CharField(max_length=40 , blank=True)
    ...
    catégorie_socioprofessionnal = models.CharField(max_length=40 , blank=True)
    casier = models.CharField(max_length=20 , blank=True)
    Biométrie = models.CharField(max_length=400 , blank=True)
